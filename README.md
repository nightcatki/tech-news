...
- 优先排除最近 7 天已经出现过的新闻链接，减少每日重复
- 为高分新闻生成“重点解读”字段
- 抓取近期中国政策与国际政策，聚焦 AI、算法、数据、算力、芯片、网络安全等方向，显示在底部“政策”页
...
3. 填入 API Key 并保存
4. 回到“今日”或“政策”，点击卡片底部的“翻译”

Key 只保存在当前浏览器本地。翻译成功后会缓存到本地；如翻译效果不好，可点击“重译”重新调用 API。
